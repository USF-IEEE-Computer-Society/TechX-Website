  ...
  return (
    <div id="Team" className={'w-full h-auto bg-[#F5F5F5]'}>
      <div className={'w-full flex flex-col justify-center items-center gap-3'}>
        ...
        <p className={'w-[90%] text-md md:text-2xl font-semibold text-ellipsis text-gray-600 text-center text-pretty mt-4'}>Student Organizers</p>
      </div>
      ...
      <p className={'w-full text-md md:text-2xl font-semibold text-ellipsis text-gray-600 text-center justify-center text-pretty mt-8'}>
        {' '}
        Student Volunteers{' '}
      </p>
